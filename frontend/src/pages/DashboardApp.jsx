      ...
      <main className="portal-content">
        <section className="org-hero" style={{ background: 'linear-gradient(120deg, #7c3aed, #4c1d95)' }}>
          <div className="org-hero-inner">
            <span className="org-hero-logo" style={{ background: '#7c3aed' }}>
              GD
            </span>
            <div>
            ...
            {loading ? (
              ...
              <div className="gallery-grid">
                {orgs.map((org) => (
                  ...
                  >
                    <span className="gallery-card-thumb" style={{ background: '#7c3aed' }}>
              ...
              {projects.length === 0 ? (
                ...
                <div className="gallery-grid">
                  {projects.map((p) => (
                    ...
                    >
                      <span className="gallery-card-thumb" style={{ background: '#4c1d95' }}>
